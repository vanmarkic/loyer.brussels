  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto">
          <div className="text-center text-white mb-8">
            <h1 className="text-3xl md:text-4xl font-bold uppercase">
              Calculateur de loyer indicatif
            </h1>
            <p className="mt-2 max-w-2xl mx-auto">
              Estimez le loyer de référence pour un bien à Bruxelles en fonction de ses
              caractéristiques
            </p>
          </div>
      ...
      <footer className="bg-[#7b3f98] text-white py-4 px-6 text-center text-sm">
        <p>
          © 2023 Service Public Régional de Bruxelles - Bruxelles Logement. Tous droits
          réservés.
        </p>
      </footer>
    </div>
