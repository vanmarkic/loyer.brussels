...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'ResultStep.actualRentSection.emailPlaceholder': 'votre.email@exemple.com',
      ...
      'ResultStep.actualRentSection.errorMessage': 'Erreur lors de la mise à jour',
    };
...
describe('ResultStep - Phone Input Bug Fix', () => {
  ...
  it('should allow typing in phone input field immediately without getting disabled', async () => {
    ...
    const phoneInput = screen.getByPlaceholderText(/actualRentSection.phonePlaceholder/i);
  ...
  it('should allow typing in rent input field immediately without getting disabled', async () => {
    ...
    const rentInput = screen.getByPlaceholderText(/actualRentSection.rentPlaceholder/i);
  ...
  it('should handle form submission when record creation is delayed', async () => {
    ...
    const rentInput = screen.getByPlaceholderText(/actualRentSection.rentPlaceholder/i);
    const phoneInput = screen.getByPlaceholderText(/actualRentSection.phonePlaceholder/i);
    const emailInput = screen.getByPlaceholderText(/actualRentSection.emailPlaceholder/i);
    ...
    // The update should also be called with the user data
    await waitFor(
      () => {
